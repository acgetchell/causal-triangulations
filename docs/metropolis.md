...
6. If all retries fail because no local site is valid, return `CdtError::MetropolisMoveApplicationFailed` with the step, move type, retry count, and the most specific local failure observed.
