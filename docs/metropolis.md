...
The integration test `test_toroidal_metropolis_preserves_topology_after_many_accepted_moves` covers this contract by running a seeded S¹×S¹ simulation, requiring at least 100 accepted moves, and checking final topology, foliation, causality, cell classification, and Euler characteristic.
