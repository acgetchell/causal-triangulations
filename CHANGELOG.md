...
- feat: migrate DelaunayBackend to upstream key-based handles [`#54`](https://github.com/acgetchell/causal-triangulations/pull/54)

### Added

- **Remove stale thread-safety warning; add ThreadSafeBackend impl** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Add NotImplemented error variant for mutation stubs** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Added: Add Crates.io and Docs.rs badges to README** [`88e8f1a`](https://github.com/acgetchell/causal-triangulations/commit/88e8f1a)
...
- **Replace UUID-based handles with upstream VertexKey/EdgeKey/CellKey** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Replace generic InvalidHandle(String) with typed error variants** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

  (InvalidVertex, InvalidEdge, InvalidFace) including the failing key

- **Update and consolidate tests: 27 backend tests covering all query** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

  methods, invalid-handle error variants, dimension, Euler
  characteristic, face-neighbor symmetry, and thread safety

- **Changed: use TDS key checks for handle validation and log stubs** [`aa0ca36`](https://github.com/acgetchell/causal-triangulations/commit/aa0ca36)
...
- **Changed: Consolidate and refine crate keywords** [`41a8212`](https://github.com/acgetchell/causal-triangulations/commit/41a8212)
...
- **Own DelaunayTriangulation directly (remove Arc/RefCell/PhantomData)** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Delete DelaunayEdgeCache and count\_edges\_in\_tds; use upstream** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

  edges()/incident_edges()/vertex_coords()/cell_vertices()/
  cell_neighbors()/adjacent_cells() iterators

- **Remove unused GeometryError variant and uuid dependency** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Drop unnecessary \[f64; D\] serde bounds from all trait impl blocks** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Simplify CoordinateScalar trait (remove bounds implied by Float)** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)

- **Remove stale "Send + Sync requirements removed" note from** [`da3ba1d`](https://github.com/acgetchell/causal-triangulations/commit/da3ba1d)
...
- **refactor: separate is_valid from is_delaunay, add test coverage, harden test guards**
  [`c0c8236`](https://github.com/acgetchell/causal-triangulations/commit/c0c8236)
...
- **refactor: improve error types, simplify trait bounds, and re-enable determinism test**
  [`2fe2953`](https://github.com/acgetchell/causal-triangulations/commit/2fe2953)
...
- **Merge pull request #75 from acgetchell/release/v0.0.1** [`f487675`](https://github.com/acgetchell/causal-triangulations/commit/f487675)

  chore(release): release v0.0.1

- **Bump actions-rust-lang/setup-rust-toolchain from 1.15.2 to 1.15.4** [`902a210`](https://github.com/acgetchell/causal-triangulations/commit/902a210)
  ...
  - [Commits](https://github.com/actions-rust-lang/setup-rust-toolchain/compare/1780873c7b576612439a134613cc4cc74ce5538c...150fca883cd4034361b621bd4e6a9d34e5143606)
...
- **Bump astral-sh/setup-uv from 7.3.0 to 7.6.0** [`c99861a`](https://github.com/acgetchell/causal-triangulations/commit/c99861a)

  Bumps [astral-sh/setup-uv](https://github.com/astral-sh/setup-uv) from 7.3.0 to 7.6.0.
  - [Release notes](https://github.com/astral-sh/setup-uv/releases)
  - [Commits](https://github.com/astral-sh/setup-uv/compare/eac588ad8def6316056a12d4907a9d4d84ff7a3b...37802adc94f370d6bfd71619e3f0bf239e1f3b78)
...
- **Bump taiki-e/install-action from 2.68.6 to 2.68.35** [`95bf128`](https://github.com/acgetchell/causal-triangulations/commit/95bf128)

  Bumps [taiki-e/install-action](https://github.com/taiki-e/install-action) from 2.68.6 to 2.68.35.
  - [Release notes](https://github.com/taiki-e/install-action/releases)
  - [Changelog](https://github.com/taiki-e/install-action/blob/main/CHANGELOG.md)
  - [Commits](https://github.com/taiki-e/install-action/compare/470679bc3a1580072dac4e67535d1aa3a3dcdf51...94a7388bec5d4c8dd93e3ebf09e0ff448f3f6f4d)
...
- **Bump actions/upload-artifact from 6.0.0 to 7.0.0** [`bd961ba`](https://github.com/acgetchell/causal-triangulations/commit/bd961ba)
...
- **Merge pull request #74 from acgetchell/refactor/rename-and-upgrade-delaunay-0.7.2**
  [`026bf7e`](https://github.com/acgetchell/causal-triangulations/commit/026bf7e)

  refactor: rename crate to causal-triangulations and upgrade to delaun…

- **Changed: Update changelog for crate rename and delaunay v0.7.2 upgrade** [`95998e0`](https://github.com/acgetchell/causal-triangulations/commit/95998e0)
...
- **Changed: Harden and reorganize Python test suite** [`2bbe623`](https://github.com/acgetchell/causal-triangulations/commit/2bbe623)
...
- **refactor: rename crate to causal-triangulations and upgrade to delaunay v0.7.2**
  [`cbc5935`](https://github.com/acgetchell/causal-triangulations/commit/cbc5935)
...
- **refactor: remove Kani and update dev documentation** [`a48c38a`](https://github.com/acgetchell/causal-triangulations/commit/a48c38a)
...
- **chore: fix review findings across docs, scripts, and backend** [`6195b11`](https://github.com/acgetchell/causal-triangulations/commit/6195b11)
...
- **Merge pull request #71 from acgetchell/dependabot/github_actions/actions-rust-lang/setup-rust-toolchain-1.15.4**
  [`3187ca9`](https://github.com/acgetchell/causal-triangulations/commit/3187ca9)
...
- **Merge pull request #73 from acgetchell/dependabot/github_actions/astral-sh/setup-uv-7.6.0**
  [`49fa916`](https://github.com/acgetchell/causal-triangulations/commit/49fa916)
...
- **Merge pull request #72 from acgetchell/dependabot/github_actions/taiki-e/install-action-2.68.35**
  [`0780778`](https://github.com/acgetchell/causal-triangulations/commit/0780778)
...
- **Merge pull request #64 from acgetchell/dependabot/github_actions/actions/upload-artifact-7.0.0**
  [`c09846c`](https://github.com/acgetchell/causal-triangulations/commit/c09846c)
